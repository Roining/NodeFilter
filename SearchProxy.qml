...
console.log("index.row after " + array);
    ...
    width:tee.width
     height:tee.height - search.height - hbar.height
...
onEditingFinished: {
    ...
    ScrollBar.horizontal: ScrollBar { id: hbar;height:8;
        policy: ScrollBar.AlwaysOn;active: true;}
                ScrollBar.vertical: ScrollBar { id: vbar;width:8; policy: ScrollBar.AlwaysOn;active: true;}
}
