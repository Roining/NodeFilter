...
Component.onCompleted: {
    ...
    if(settings.arrayOfWindows.length ===0){
        var component = Qt.createComponent("WindowComponent.qml");
                       var window    = component.createObject(you);
          you.array.push(window)
           window.showMaximized();
   ...
   for(var i = 0;i< settings.arrayOfWindows.length;i++){
        var component = Qt.createComponent("WindowComponent.qml");
                       var window    = component.createObject(you);
          you.array.push(window)
           window.showMaximized();
...
//       }
      var obj = JSON.parse(settings.arrayOfWindows[i])
       window.x = obj.you.array[i].x;
       window.y = obj.you.array[i].y;
       window.width = obj.you.array[i].width;
       window.height = obj.you.array[i].height;
...
for(var j = 1; j<obj.length;j++){
 ...
 //        var   sprite = delegateInstance.createObject(tes,{test:component})
 //        sprite.focus === true;
    delegateInstance.x = obj[j].x
    delegateInstance.y = obj[j].y
    delegateInstance.width = obj[j].width
    delegateInstance.height = obj[j].height
    delegateInstance.search.text = obj[j].search.text
